...
#         self._current_query = query
#         self.query_processor = QueryProcessor(self.inverted_index, self.preprocessed_documents)
#         boolean_results, vsm_results, okapiBM25_results, bert_results = self.query_processor.process_query(self._current_query)
#         return boolean_results, vsm_results, okapiBM25_results, bert_results
